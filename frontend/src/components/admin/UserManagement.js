      ...
      {showPinModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-[60] p-4" data-testid="wallet-pin-modal">
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl">
            <div className="px-6 py-4 border-b border-slate-100"><h3 className="text-sm font-bold text-slate-900">{pinMode === 'create' ? 'Create Security PIN' : 'Verify Admin PIN'}</h3><p className="text-[10px] text-slate-400 mt-1">{adjustTarget ? 'Required to adjust teacher balance' : 'Required to adjust wallet balance'}</p></div>
