...
export default function TeacherSignup() {
  ...
  const benefits = [
    { icon: Users, text: 'Connect with students worldwide' },
    { icon: Star, text: 'Set your own schedule and rates' },
    { icon: BookOpen, text: 'Access teaching resources and tools' },
  ];
    ...
    <div className="min-h-screen" className="bg-[#FBFBFD]">
      ...
      <div className="min-h-screen flex items-center justify-center px-6 py-24">
        <div className="w-full max-w-lg">
          ...
          >
            <button
              data-testid="teacher-google-login"
              onClick={handleGoogleLogin}
              disabled={isLoading}
              className="w-full h-14 rounded-full flex items-center justify-center gap-3 text-lg font-medium transition-all hover:scale-[1.02] disabled:opacity-50"
              style={{ 
