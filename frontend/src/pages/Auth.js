          ...
          <AnimatePresence mode="wait">
            ...
            {mode === 'login' && (
              <motion.div
                ...
                exit={{ opacity: 0, x: -20 }}
              >
                <h2 className="text-[28px] font-semibold text-[#1D1D1F] tracking-tight mb-1.5">
                  Welcome Back
                </h2>
                <p className="text-gray-400 text-[15px] mb-8">Log in to continue your learning journey</p>
                ...
                <form onSubmit={handleEmailLogin} className="space-y-5">
                  ...
                  <div>
                    ...
                    {emailExists && authProvider === 'google' && (
                      <p className="text-xs text-amber-500 mt-1.5">This account uses Google login</p>
                    )}
                  </div>

                  {/* Password */}
                  <div>
                    <label className="block text-[13px] font-medium text-gray-600 mb-2">Password</label>
                    <div className="relative">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full apple-btn-secondary !h-12 !rounded-xl gap-3"
                >
