  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDFBF7' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-medium" style={{ color: '#044E42' }}>Browse Teachers</span>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-medium mb-2" style={{ color: '#044E42' }}>Our Expert Teachers</h1>
              ...
              >
                <div className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    />
                    <div>
                      <h3 className="text-xl font-medium" style={{ color: '#044E42' }}>
                        {teacher.user?.name}
                      </h3>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {teacher.specializations.map((spec, i) => (
                          <span
                            ...
                            style={{ backgroundColor: '#F7F3E8', color: '#044E42' }}
                          >
                            {spec}
                          </span>
                        ))}
                  ...
                  <button
                    ...
                    className="w-full h-10 px-6 rounded-full bg-[#044E42] text-white font-medium transition-all hover:scale-105 hover:shadow-lg active:scale-95"
                  >
                    Book Class
                  </button>
                </div>
