    ...
    <div className="min-h-screen bg-[#fbfaf6] text-[#0f2e24] py-24 px-8 md:px-12">
      <div className="max-w-3xl mx-auto">
        ...
        <ul className="space-y-3 mb-6 ml-4">
          ...
          <li className="font-['Bricolage_Grotesque'] text-lg leading-relaxed opacity-85"><strong>Onboarding &amp; Educational Data:</strong> User role (Student, Parent, or Teacher), current reading level, learning goals, schedule preferences, and progress tracking data.</li>
